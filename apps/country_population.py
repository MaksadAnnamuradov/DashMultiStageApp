...
layout = html.Div([
    dcc.Dropdown(id='country_population_dpdn', value=['Germany','Brazil'], multi=True,
                 options=[{'label': x, 'value': x} for x in
                          df.country.unique()]),
    html.Div([
        dcc.Graph(id='country_pie_graph', figure={}, className='six columns'),
        dcc.Graph(id='country_population_ln_graph', figure={}, clickData=None, hoverData=None, # I assigned None for tutorial purposes. By defualt, these are None, unless you specify otherwise.
                  config={
...
@app.callback(
    Output(component_id='country_population_ln_graph', component_property='figure'),
    Input(component_id='country_population_dpdn', component_property='value'),
)
...
@app.callback(
    ...
    Input(component_id='country_population_ln_graph', component_property='clickData'),
    Input(component_id='country_population_ln_graph', component_property='selectedData'),
    Input(component_id='country_population_dpdn', component_property='value')
)
